const Card_AllVotes = ({usernameVote, vote}) => {
    return (
        ...
        <div className="containerCard_finalVote"><h1>13</h1><p>Marta</p></div>
        <div className="containerCard_finalVote"><h1>5</h1><p>Antonio</p></div>
        <div className="containerCard_finalVote elderly"><h1>1</h1><p>Lara</p></div>
